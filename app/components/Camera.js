...
export default class CameraEx extends React.Component {
    ...
    static getDerivedStateFromProps(nextProps) {
        return {
            currentPreviewId: nextProps.currentPreviewId
        }
    ...
    addImagetoArray(e) {
        this.state.currentPreviewId === '' ? this.props.addfunc(e) : this.props.editfunc(e, this.state.currentPreviewId)
    }
    cancle() {
        this.setState({ photo: '' })
    }
    render() {
        console.log('Render ===> ', this.state.currentPreviewId)
                    ...
                    <View style={{ flex: 1 }}>
                        ...
                        <View
                            ...
                            <View style={{
                                ...
                                <TouchableOpacity onPress={() => this.props.galleryItems()} style={{ alignItems: 'center', }} >
                                    <Image
